$(document).ready(function() {
    ...
    var sloths = ["Giant Ground Sloths", "Two-toed Sloths", "Three-toed Sloths", "Baby Sloths"];
    ...
    //clears container when search is hit
    $("#add-animal").on("click", function(event) {
        $("#animal-input").val("");
    });

    //clears images when new animal is selected
    $("#buttons-view").on("click", function(event) {
        $("#animal-gifs").empty();
        $(".header").html("Don't be a sloth! Click the gifs!");
    });
